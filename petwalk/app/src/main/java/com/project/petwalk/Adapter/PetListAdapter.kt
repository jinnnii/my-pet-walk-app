...
class PetListAdapter(
    val arrAnimalImages: ArrayList<String>,
    val arrAnimal: ArrayList<String>,
    val arrName: ArrayList<String>,
    val arrKind: ArrayList<String>
) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        Glide.with(binding.root.context).load(arrAnimalImages[position])
            .into(binding.imgPet)
        binding.textView6.text = arrAnimal[position]
        binding.tvName.text = arrName[position]
        binding.tvPhone.text = arrKind[position]
